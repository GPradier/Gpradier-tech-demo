...
if ($locales = Environment::get('locales')) {
	...
	//Router::connect('/{:locale:[a-zA-Z_]+}/{:args}', array(), array('continue' => true)); // bad
}
...
///{:controller}/{:action}/{:id:[0-9a-f]{24}}
//Router::connect('/mobile/favorites/add/{:id:[0-9a-f]{24}}', array('controller' => 'Favoris', 'action' => 'add', 'type' => 'json'));
Router::connect('/mobile/object/{:action}/{:id:[0-9a-f]{24}}', array('controller' => 'Object'));
